        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('documents.export') }}">
                        {{ csrf_field() }}
                    ...
                    <form class="form-horizontal" method="POST" action="{{ route('documents.import') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
